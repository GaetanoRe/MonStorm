...
public abstract class CreatureDefinition : ScriptableObject
{
    ...
    [field: Header("Creature Properties"), SerializeField] public string CreatureName { get; private set; }
    /// <summary>The starting and maximum health of the creature.</summary>
