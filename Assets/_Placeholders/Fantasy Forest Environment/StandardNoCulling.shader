    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input, bool isFrontFace : SV_IsFrontFace) : SV_Target
            {
                ...
                half3 finalRGB = albedo * (lighting + ambient);
        ...
        // Shadow caster — alpha-clip aware
        Pass
        {
            Name "ShadowCaster"
        ...
        // Depth-only — needed for post-processing effects like SSAO
        Pass
        {
            Name "DepthOnly"
            ...
            VaryingsDepth DepthVert(AttributesDepth input)
            {
